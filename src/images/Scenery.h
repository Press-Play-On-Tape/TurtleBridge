...
namespace Images {
  ...
  const unsigned char PROGMEM Ground_Left_Mask[] = {
  ...
  const unsigned char PROGMEM Ground_Right[] = {
  11, 56,
  ...
  const unsigned char PROGMEM Ground_Right_Mask[] = {
  ...
  const unsigned char PROGMEM Ground_Bottom_Mask[] = {
  ...
  const unsigned char PROGMEM SkyBackground[] = {
  128, 32,
  ...
  const unsigned char PROGMEM Seaweed[] = {
  4, 10,
  0xb2, 0x4d, 0xb2, 0x4d, 
  0x01, 0x02, 0x01, 0x02, 
  ...
  const unsigned char PROGMEM Seaweed_Mask[] = {
  0xff, 0xff, 0xff, 0xff, 
  0x03, 0x03, 0x03, 0x03, 
  };
